...
public class DAN {
	static public final String version = "20160107b-t";
...
//    				while (!queue.isEmpty()) {	// This may cause starvation
    ...
    static private void logging (String message) {
        System.out.println("["+ log_tag +"][DAN] " + message);
    }
    ...
    // * Public API * //
    // ************** //
    static public void init (String device_model) {
