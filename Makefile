...
SOURCE_CLASS_FILES: ${OUTPUT_FOLDER}
	javac -classpath ${CLASSPATH} -d ${OUTPUT_FOLDER} -sourcepath ${SRC_DIR} ${SRC_DIR}/${MAIN_CLASS}.java

${MANIFEST_FILE}: ${OUTPUT_FOLDER}
	sh build-tools/setup-manifest.sh ${MAIN_CLASS} ${OUTPUT_FOLDER}/${MANIFEST_FILE}
